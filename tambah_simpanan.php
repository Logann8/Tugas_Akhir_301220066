...
<body>
    ...
    <div class="main-content">
        <h4 class="fw-bold mb-4">Tambah Simpanan</h4>
        <div class="card p-4">
            <form action="proses_tambah_simpanan.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control" id="tanggal" name="tanggal" value="<?php echo date('Y-m-d H:i'); ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="fee" name="fee" value="0" min="0">
                </div>
                <button type="submit" class="btn btn-primary rounded-pill px-4"><i class="bi bi-plus"></i> Tambah Simpanan</button>
